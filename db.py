...
class Database:
    ...
    def __init__(self, uri='mongodb://localhost:27017', db_name='RezkaDB'):
        logger.info(f'Подключаемся к базе данных: {uri}')
    ...
    def delete(self, collection_name, query, multiply=False):
        """
